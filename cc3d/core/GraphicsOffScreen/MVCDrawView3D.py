...
class MVCDrawView3D(MVCDrawViewBase):
    ...
    def set3DInvisibleTypes(self):
        ...
        configuraton = persistent_globals.configuration

        self.colorMap = configuraton.getSetting("TypeColorMap")

        typesInvisibleStrTmp = str(configuraton.getSetting("Types3DInvisible"))
        # print "GOT ",typesInvisibleStrTmp
        if typesInvisibleStrTmp != self.typesInvisibleStr:
            self.typesInvisibleStr = str(configuraton.getSetting("Types3DInvisible"))
