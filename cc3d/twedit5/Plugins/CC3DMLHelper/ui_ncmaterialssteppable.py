...
# Form implementation generated from reading ui file 'ncmaterialssteppabledlg.ui'
#
...
class Ui_NCMaterialsSteppableDlg(object):
    def setupUi(self, NCMaterialsSteppableDlg):
        NCMaterialsSteppableDlg.setObjectName("NCMaterialsSteppableDlg")
        NCMaterialsSteppableDlg.resize(823, 585)
        self.gridLayout = QtWidgets.QGridLayout(NCMaterialsSteppableDlg)
        self.gridLayout.setObjectName("gridLayout")
        self.buttonBox = QtWidgets.QDialogButtonBox(NCMaterialsSteppableDlg)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.gridLayout.addWidget(self.buttonBox, 1, 0, 1, 1)
        self.tabWidget = QtWidgets.QTabWidget(NCMaterialsSteppableDlg)
        ...
        self.retranslateUi(NCMaterialsSteppableDlg)
        self.tabWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(NCMaterialsSteppableDlg)

    def retranslateUi(self, NCMaterialsSteppableDlg):
        _translate = QtCore.QCoreApplication.translate
        NCMaterialsSteppableDlg.setWindowTitle(_translate("NCMaterialsSteppableDlg", "NCMaterials Steppable: Please define noncellular material interactions"))
        self.label.setText(_translate("NCMaterialsSteppableDlg", "Catalyst"))
        self.label_2.setText(_translate("NCMaterialsSteppableDlg", "Reactant"))
        self.label_3.setText(_translate("NCMaterialsSteppableDlg", "Coefficient"))
        self.pushButton_mtlAdd.setText(_translate("NCMaterialsSteppableDlg", "Add Interaction"))
        self.pushButton__mtlDel.setText(_translate("NCMaterialsSteppableDlg", "Delete Interaction"))
        self.pushButton__mtlClear.setText(_translate("NCMaterialsSteppableDlg", "Clear Table"))
        item = self.tableWidget_mtl.horizontalHeaderItem(0)
        item.setText(_translate("NCMaterialsSteppableDlg", "Catalyst"))
        item = self.tableWidget_mtl.horizontalHeaderItem(1)
        item.setText(_translate("NCMaterialsSteppableDlg", "Reactant"))
        item = self.tableWidget_mtl.horizontalHeaderItem(2)
        item.setText(_translate("NCMaterialsSteppableDlg", "Coefficient"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("NCMaterialsSteppableDlg", "Material Interactions"))
        self.label_4.setText(_translate("NCMaterialsSteppableDlg", "Catalyst"))
        self.label_5.setText(_translate("NCMaterialsSteppableDlg", "Reactant"))
        self.label_6.setText(_translate("NCMaterialsSteppableDlg", "Coefficient"))
        self.pushButton_fldAdd.setText(_translate("NCMaterialsSteppableDlg", "Add Interaction"))
        self.pushButton_fldDel.setText(_translate("NCMaterialsSteppableDlg", "Delete Interaction"))
        self.pushButton_fldClear.setText(_translate("NCMaterialsSteppableDlg", "Clear Table"))
        ...
        item.setText(_translate("NCMaterialsSteppableDlg", "Coefficient"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("NCMaterialsSteppableDlg", "Field Interactions"))
        self.label_7.setText(_translate("NCMaterialsSteppableDlg", "NCMaterial"))
        self.label_8.setText(_translate("NCMaterialsSteppableDlg", "Cell Type"))
        self.label_9.setText(_translate("NCMaterialsSteppableDlg", "Response Type"))
        self.label_10.setText(_translate("NCMaterialsSteppableDlg", "Coefficient"))
        self.label_11.setText(_translate("NCMaterialsSteppableDlg", "New Cell Type: "))
        self.pushButton_cellAdd.setText(_translate("NCMaterialsSteppableDlg", "Add Interaction"))
        self.pushButton_cellDel.setText(_translate("NCMaterialsSteppableDlg", "Delete Interaction"))
        self.pushButton_cellClear.setText(_translate("NCMaterialsSteppableDlg", "Clear Table"))
        item = self.tableWidget_cell.horizontalHeaderItem(0)
        item.setText(_translate("NCMaterialsSteppableDlg", "NCMaterial"))
        item = self.tableWidget_cell.horizontalHeaderItem(1)
        item.setText(_translate("NCMaterialsSteppableDlg", "Cell Type"))
        item = self.tableWidget_cell.horizontalHeaderItem(2)
        item.setText(_translate("NCMaterialsSteppableDlg", "Response Type"))
        item = self.tableWidget_cell.horizontalHeaderItem(3)
        item.setText(_translate("NCMaterialsSteppableDlg", "Coefficient"))
        item = self.tableWidget_cell.horizontalHeaderItem(4)
        item.setText(_translate("NCMaterialsSteppableDlg", "New Cell Type"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("NCMaterialsSteppableDlg", "Cell Interactions"))
        item = self.tableWidget_diff.horizontalHeaderItem(0)
        item.setText(_translate("NCMaterialsSteppableDlg", "NCMaterial"))
        item = self.tableWidget_diff.horizontalHeaderItem(1)
        item.setText(_translate("NCMaterialsSteppableDlg", "Diffuses"))
        item = self.tableWidget_diff.horizontalHeaderItem(2)
        item.setText(_translate("NCMaterialsSteppableDlg", "Coefficient"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("NCMaterialsSteppableDlg", "Material Diffusion"))
