    ...
    def start(self):
        ...
        for cell in self.cell_list:
            ...
            if isinstance(specificity_obj, list):
                c_multi_cad_data.assignValue(0, (specificity_obj[1] - specificity_obj[0]) * random.random())
                c_multi_cad_data.assignValue(1, (specificity_obj[1] - specificity_obj[0]) * random.random())
            else:
