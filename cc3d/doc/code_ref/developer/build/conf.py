...
if sys.platform.startswith('win'):
    ...
    graphviz_dot = [x for x in os.listdir(os.path.join(os.path.dirname(sys.executable)))
                    if x == "dot"][0]
    graphviz_dot = os.path.join(os.path.dirname(sys.executable), graphviz_dot)
