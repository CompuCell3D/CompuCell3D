...
#    def setXAxisTitle(self,_title):
    ...
    def __showPlot(self,plotName,_mutex=None):
        ...
        print(MODULENAME,'  __showPlot():   self.plotData.keys()=',list(self.plotData.keys()))
        print(MODULENAME,'  __showPlot():   self.plotDrawingObjects.keys()=',list(self.plotDrawingObjects.keys()))
...
#        self.pW.replot()
    ...
    def __showAllPlots(self,_mutex=None):
        print(MODULENAME,'  __showAllPlots():   self.plotDrawingObjects.keys()=',list(self.plotDrawingObjects.keys()))
