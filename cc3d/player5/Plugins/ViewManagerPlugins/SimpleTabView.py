...
class SimpleTabView(MainArea, SimpleViewManager):
    ...
    def initializeSimulationViewWidget(self):
        ...
        initializeSimulationViewWidgetFcn = getattr(self, "initializeSimulationViewWidget" + str(self.__viewManagerType))
    ...
    def handleSimulationFinishedCMLResultReplay(self, _flag):
        ...
        '''
        persistent_globals = CompuCellSetup.persistent_globals
        if persistent_globals.player_type == ViewManagerType.REPLAY:
