...
/* Consistent sizing for tab containers */
.tab-container {
    width: 100%;
    max-width: 1200px;
    margin: 0 auto;
...
def get_defaults():
    return {
        ...
        "CellType": [{"Cell type": "Medium", "id": 0, "freeze": False}], # still need to change to cell tpye spec_dict
        "Plugins": {
            "AdhesionFlexPlugin": {},
...
class PottsWidget:
    ...
    def create_ui(self):
        ...
        return VBox([
            HTML("<b>Potts Core Parameters</b>", layout=Layout(display='flex', justify_content='flex-start')),
            dimensions_row,
            core_params_row,
            fluct_function_row,
            HTML("<b>Boundary Conditions:</b>", layout=Layout(display='flex', justify_content='flex-start')),
            boundaries_row,
            HTML("<b>Advanced Settings:</b>", layout=Layout(display='flex', justify_content='flex-start')),
            advanced_row1,
            advanced_row2,
            HBox([self.widgets["reset_button"]], layout=Layout(justify_content='flex-start'))
...
class CellTypeWidget:
    ...
    def setup_event_handlers(self):
        # Now safe to access reset_button
    ...
    def create_ui(self):
        ...
        reset_button_box = HBox([self.widgets["reset_button"]], layout=Layout(justify_content='flex-start'))
        return VBox([
            HTML("<b>Cell Types</b>", layout=Layout(display='flex', justify_content='flex-start')),
