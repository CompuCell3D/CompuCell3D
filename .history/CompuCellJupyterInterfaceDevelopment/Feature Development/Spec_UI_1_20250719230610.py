...
class PottsWidget:
    ...
    def create_ui(self):
        ...
        ], layout=Layout(justify_content='left', align_items='left'))
...
class CellTypeWidget:
    ...
    def setup_event_handlers(self):
        ...
        # REMOVED: Reset All button event handler
...
class SpecificationSetupUI:
    ...
    def create_metadata_tab(self):
        ...
        reset_button_box = HBox([self.widgets["reset_metadata_button"]], layout=Layout(justify_content='flex-startr'))
        
        return VBox([
            HTML("<b>Simulation Metadata</b>", layout=Layout(display='flex', justify_content='flex-start')),
            num_processors_box,
            debug_frequency_box,
            reset_button_box
        ])
