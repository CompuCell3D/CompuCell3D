...
class Ui_C_Plus_Plus_Module_Dialog(object):
    def setupUi(self, C_Plus_Plus_Module_Dialog):
        ...
        self.widget = QtWidgets.QWidget(C_Plus_Plus_Module_Dialog)
        ...
        self.moduleTypeGB = QtWidgets.QGroupBox(self.widget)
        ...
        self.pluginFunctionalityGB = QtWidgets.QGroupBox(self.widget)
        ...
        self.moduleTypeGB.raise_()
        self.pluginFunctionalityGB.raise_()
        self.groupBox.raise_()
        self.extraAttribCB.raise_()
