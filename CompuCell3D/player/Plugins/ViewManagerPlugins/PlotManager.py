...
class PlotWindowInterface(QtCore.QObject):
    ...
    showPlotSignal = pyqtSignal('QString', 'QMutex')
    showAllPlotsSignal = pyqtSignal('QMutex')
    showHistPlotSignal = QtCore.pyqtSignal('QString', 'QMutex')
    showAllHistPlotsSignal = QtCore.pyqtSignal('QMutex')

    showBarCurvePlotSignal = QtCore.pyqtSignal('QString','QMutex')
    showAllBarCurvePlotsSignal = QtCore.pyqtSignal('QMutex')

    savePlotAsPNGSignal = QtCore.pyqtSignal('QString', 'int', 'int',
                                             'QMutex')  # savePlotAsPNG has to emit signal with locking mutex to work correctly
