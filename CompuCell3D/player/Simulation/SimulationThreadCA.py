...
import CAFieldUtils # have to import this I I want to avoid crash during CA simulation running when the run happens right after any CPM simulation
    
class SimulationThreadCA(QtCore.QThread):
    ...
    def __init__(self, parent=None):
        ...
        self.sim=None # reference to CA.CAManager()
...
#        print '-------- Sim-Thread.py:  loopWorkPostEvent(), _mcs=',_mcs
    ...
    def runUserPythonScript(self,_scriptFileName,_globals,_locals):        
        ...
        # # # time.sleep(3)
        # # # sys.exit()
        # print 'ABOUT TO RUN CA.PY'
        # import time
        # time.sleep(2)
            
        execfile("pythonSetupScripts/CompuCellPythonSimulationNewPlayerCA.py")
