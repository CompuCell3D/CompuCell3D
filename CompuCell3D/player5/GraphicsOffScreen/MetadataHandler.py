class MetadataHandler(object):
    ...
    def get_metadata(self, key, default=None, data_type=None):
        """
        ...
        try:
            ...
            if default is not None:
                print('Could not find key {} in metadata . Returning provided default of {}'.format(key, default))
                return default
            elif data_type is not None:
                try:
                    default_type_val = self._defaults[default]
                    print('Could not find key {} in metadata . Returning type default of {}'.format(key,
                                                                                                    default_type_val))
                except KeyError:
