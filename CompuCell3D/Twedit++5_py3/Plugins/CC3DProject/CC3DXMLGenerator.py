...
class CC3DXMLGenerator:
    ...
    def generateCellTypePlugin(self):
        ...
        for id, typeTuple in self.idToTypeTupleDict.items():
            dict = {}
    ...
    def generateSecretionPlugin(self):
        ...
        for chemFieldName, secrDictList in self.secretionTable.items():
    ...
    def generateChemotaxisPlugin(self):
        ...
        for chemFieldName, chemDictList in self.chemotaxisTable.items():
    ...
    def generatePDESolverCaller(self):
        ...
        for solver in list(solverDict.keys()):
    ...
    def generatePDESolvers(self):
        ...
        for solver, fieldNames in solverDict.items():
