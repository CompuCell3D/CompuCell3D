...
//ForceCalculator_autogenerated1
...
//ForceCalculator_autogenerated2
%include <CompuCell3D/steppables/ForceCalculator/ForceCalculator.h>
%template (forcecalculatordata) BasicClassAccessor<ForceFieldData>;



%inline %{

 ForceCalculator * getForceCalculatorSteppable(){

      return (ForceCalculator *)Simulator::steppableManager.get("ForceCalculator");
