...
%template (ncmaterialsdataaccessor) BasicClassAccessor<NCMaterialsData>; //necessary to get NCMaterialsData accessor working
%template (ncmaterialcomponentdataaccessor) BasicClassAccessor<NCMaterialComponentData>; //necessary to get NCMaterialComponentData accessor working
%template (ncmaterialcelldataaccessor) BasicClassAccessor<NCMaterialCellData>; //necessary to get NCMaterialCellData accessor working
PLUGINACCESSOR(NCMaterials)
