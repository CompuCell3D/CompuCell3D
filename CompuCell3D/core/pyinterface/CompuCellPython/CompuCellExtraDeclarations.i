...
//TESTSTEPPABLE_autogenerated1
#define TESTSTEPPABLE_EXPORT
//NeighborSurfaceConstraint_autogenerated1
...
//TESTSTEPPABLE_autogenerated2

%include <CompuCell3D/steppables/TESTSTEPPABLE/TESTSTEPPABLE.h>

%inline %{
 TESTSTEPPABLE * getTESTSTEPPABLE(){
      return (TESTSTEPPABLE *)Simulator::steppableManager.get("TESTSTEPPABLE");
   }

%}
//NeighborSurfaceConstraint_autogenerated2

%include <CompuCell3D/plugins/NeighborSurfaceConstraint/NeighborSurfaceConstraintPlugin.h>

%inline %{
 NeighborSurfaceConstraintPlugin * getNeighborSurfaceConstraintPlugin(){
      return (NeighborSurfaceConstraintPlugin *)Simulator::pluginManager.get("NeighborSurfaceConstraint");
   }
