...
//PressureCalculator_autogenerated1
...
//PressureCalculator_autogenerated2
%include <CompuCell3D/steppables/PressureCalculator/PressureCalculatorData.h>

%template (PressureCalculatorDataAccessorTemplate) BasicClassAccessor<PressureCalculatorData>; //necessary to get PressureCalculatorData accessor working in Python



%include <CompuCell3D/steppables/PressureCalculator/PressureCalculator.h>



%inline %{

 PressureCalculator * getPressureCalculator(){

      return (PressureCalculator *)Simulator::steppableManager.get("PressureCalculator");
