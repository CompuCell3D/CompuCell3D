...
%template (ecmaterialsdataaccessor) BasicClassAccessor<ECMaterialsData>; //necessary to get ECMaterialsData accessor working
%template (ecmaterialcomponentdataaccessor) BasicClassAccessor<ECMaterialComponentData>; //necessary to get ECMaterialComponentData accessor working
%template (ecmaterialcelldataaccessor) BasicClassAccessor<ECMaterialCellData>; //necessary to get ECMaterialCellData accessor working
PLUGINACCESSOR(ECMaterials)
