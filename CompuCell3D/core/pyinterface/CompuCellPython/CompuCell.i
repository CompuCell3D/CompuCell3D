...
%define CELLG_ATTRIB(attribName)
    %pythoncode %{
        def set_ ## attribName(self, ## attribName):
            raise AttributeError(f"ASSIGNMENT cell. attribName={attribName} is illegal. attribName is read only variable")
...
//%attributeref(CompuCell3D::CellG, lldb::SBModule, module, GetModule);
...
//todo - numpy uncomment     
//%define CELLFIELD3DEXTENDER_ORIG(fieldType,returnType)
// FIELD3DEXTENDERBASE(type,returnType)
