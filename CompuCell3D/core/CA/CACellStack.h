...
namespace CompuCell3D {
   ...
   class CASHARED_EXPORT CACellStack{
	   ...
	   typedef std::map<long, CACell *>::iterator stack_itr_t;
	   int fillLevel;
	   int capacity;
	   Point3D pt;
   public:
	   ...
	   bool canFit(int _size){return capacity-fillLevel>=_size;}
	   ...
	   void removeCell(CACell * _cell); //rename to removeCell
