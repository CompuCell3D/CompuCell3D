...
//namespace CompuCell3D {
	...
	CACellList::~CACellList(){}

	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	CACellInventory::CACellInventory():caManager(0)
	{
	}
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void CACellInventory::setCAManagerPtr(CAManager *_caManager){
		caManager=_caManager;
		// compartmentInventory.setPotts3DPtr(_potts);
	}

	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	CACellInventory::~CACellInventory()
	{	
	...
	void CACellInventory::cleanInventory(){
		...
		for( cInvItr = cellInventoryBegin() ; cInvItr !=cellInventoryEnd() ; ++cInvItr ){
			...
			if(!caManager){
				...
				caManager->destroyCell(cell,false);
         }
		}
		inventory.clear();
	...
	void CACellInventory::addToInventory(CACell * _cell){
		inventory.insert(make_pair(CACellIdentifier(_cell->id),_cell));
		//compartmentInventory.addToInventory(_cell);
		//inventory.insert(_cell);
	}
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void CACellInventory::removeFromInventory(CACell * _cell){
		inventory.erase(CACellIdentifier(_cell->id));
	...
	bool CACellInventory::reassignClusterId(CACell * _cell, long _newClusterId){
		cellInventoryIterator mitr = inventory.find(CACellIdentifier(_cell->id));
	...
	//CACellInventory::cellInventoryIterator CACellInventory::find(long _id){
	//	CACellInventory::cellInventoryIterator cInvItr;

	//	CACell * cell;

	//	///loop over all the cells in the inventory   
	//	for( cInvItr = CACellInventoryBegin() ; cInvItr !=CACellInventoryEnd() ; ++cInvItr ){
	//		cell=*cInvItr;
	//		if(cell->id==_id)
	//			return cInvItr;
	//	}
	//	return CACellInventoryEnd();
	//}
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//linear searh but this function will not be used too often. If necesary we can easily solve this problem later
	CACellInventory::cellInventoryIterator CACellInventory::find(CACell * _cell){
		CACellInventory::cellInventoryIterator cInvItr;
		CACell * cell;
		for( cInvItr = cellInventoryBegin() ; cInvItr !=cellInventoryEnd() ; ++cInvItr ){
			cell=getCell(cInvItr);
	...
	CACell * CACellInventory::getCellById(long _id){
	...
	CACell * CACellInventory::getCellByIds(long _id,long _clusterId){
		//CACellIdentifier cellId(_id,_clusterId);
		CACellIdentifier cellId(_id);
...
CACell * CACellInventory::attemptFetchingCellById(long _id){

	//cellInventoryIterator upperMitr=inventory.upper_bound(CACellIdentifier(_id,std::numeric_limits<long>::max())); //upperMitr will point to location whose key is 'greater' than searched key
	cellInventoryIterator upperMitr=inventory.upper_bound(CACellIdentifier(_id)); //upperMitr will point to location whose key is 'greater' than searched key
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// // // CACellList CACellInventory::getClusterCells(long _clusterId){
	// // // return compartmentInventory.getClusterCells(_clusterId);
// // // }

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void CACellInventory::initCellInventoryByType(CACellInventory::cellListByType_t *_inventoryByTypePtr,unsigned char _type){
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void CACellInventory::initCellInventoryByMultiType(CACellInventory::cellListByType_t *_inventoryByTypePtr,std::vector<int> * _typeVecPtr){
		_inventoryByTypePtr->clear();
		CACellInventory::cellInventoryIterator cInvItr;
		CACell * cell;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// // // }
	// // // /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// // // void CompartmentInventory::addToInventory(CACell * _cell){
		// // // if (!_cell)
			// // // return;
	...
	// // // }
	// // // /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// // // void CompartmentInventory::removeFromInventory(CACell * _cell){
		// // // if (!_cell)
			// // // return;
		// // // compartmentInventoryIterator mitr=inventory.find(_cell->clusterId); //see if we have this clusterId in inventory already
		// // // if(mitr!=inventory.end()){//cluster already exists
	...
	// // // }
	// // // /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// // // //bool CompartmentInventory::reassignClusterId(CACell *_cell,long _newClusterId){
	// // // //	if (!_cell)
	// // // //		return false;
