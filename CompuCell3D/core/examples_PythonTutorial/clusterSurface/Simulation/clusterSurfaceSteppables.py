...
class MitosisSteppableClusters(MitosisSteppableClustersBase):
    ...
    # def getClusterCells(self,_clusterId):
        ...
        # clusterCellList=ClusterCellList(self.clusterInventory.getClusterCells(_clusterId))
        # return None
    ...
    def step(self,mcs):        
        ...
        bs=CompuCell.BoundaryStrategy.getInstance()
        ...
        for compartmentList in self.clusterList:
            ...
            for cell in CompartmentList(compartmentList):
                ...
                for pixelTrackerData in pixelList:
                    for nIdx in range(0,4):
                        neighbor = bs.getNeighborDirect(pixelTrackerData.pixel,nIdx);
            ...
            # if(!neighbor.distance)
                ...
                # cell=self.cellField.get(pixelTrackerData.pixel)
                # print cell
        ...
        if mcs==400:
            ...
            # oldClusterId=cell1.clusterId
            # newClusterId=2            
            # self.inventory.reassignClusterId(cell1,newClusterId)
