...
# CompuCellSetup.setSimulationXMLFileName("Simulation/cellsort_2D.xml")
...
# sfs.addFileNameToStore("Simulation/cellsort_2D.xml")
# sfs.addFileNameToStore("Simulation/cellsort_2D_info_printer.py")
# sfs.addFileNameToStore("Simulation/cellsort_2D_steppables_info_printer.py")
