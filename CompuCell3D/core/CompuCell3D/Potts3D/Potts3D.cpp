...
void Potts3D::clearVolumeEnergyParameters() {
    cellType2TargetVolumeMap.clear();
    cellType2LambdaVolumeMap.clear();
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

double Potts3D::getTargetVolume(unsigned char cellType) {
    return cellType2TargetVolumeMap[cellType];
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double Potts3D::getLambdaVolume(unsigned char cellType) {
    return cellType2LambdaVolumeMap[cellType];
}

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void Potts3D::setTargetVolume(unsigned char cellType, double val){
    cellType2TargetVolumeMap[cellType] = val;
}

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void Potts3D::setLambdaVolume(unsigned char cellType, double val){
    cellType2LambdaVolumeMap[cellType] = val;
}
