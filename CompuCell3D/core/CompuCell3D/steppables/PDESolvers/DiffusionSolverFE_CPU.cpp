...
void DiffusionSolverFE_CPU::stepImpl(const unsigned int _currentStep){
 ...
 // // // for(unsigned int i = 0 ; i < diffSecrFieldTuppleVec.size() ; ++i ){
        ...
        // // // int diffIterations=diffData.extraTimesPerMCS; // For DiffusionSolverFE diffData.extraTimesPerMCS is a TOTAL number of calls to diffusion step, not "extra" calls as  for FlexibleDiffusionSolver . We simply reuse variable here
...
// // // void DiffusionSolverFE_CPU::boundaryConditionInitImpl(int idx){
