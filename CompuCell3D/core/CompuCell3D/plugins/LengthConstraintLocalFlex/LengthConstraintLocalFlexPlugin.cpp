...
LengthConstraintLocalFlexPlugin::LengthConstraintLocalFlexPlugin() : potts(0),boundaryStrategy(0),changeEnergyFcnPtr(0) {}
...
void LengthConstraintLocalFlexPlugin::setLengthConstraintData(CellG * _cell, double _lambdaLength, double _targetLength){
	if(_cell){
