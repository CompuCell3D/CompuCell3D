...
//        }
         ...
         */
        virtual Coordinates3D<T> getByIndex(long _offset) const { return Coordinates3D<T>(); }//will have to make it abstract
         ...
         * @return The value of the element at pt.
         */
        virtual Coordinates3D<T> operator[](const Point3D &pt) const { return get(pt); }
