...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/local/compucell3d.sh;/usr/local/runScript.sh;/usr/local/paramScan.sh;/usr/local/twedit++.sh")
...
file(INSTALL DESTINATION "/usr/local" TYPE FILE PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ GROUP_WRITE GROUP_EXECUTE WORLD_READ WORLD_WRITE WORLD_EXECUTE FILES
    "/N/u/mehtasau/Carbonate/CC3D_PY3_GIT/CompuCell3D/CompuCell3D/post_install_tasks/compucell3d.sh"
    "/N/u/mehtasau/Carbonate/CC3D_PY3_GIT/CompuCell3D/CompuCell3D/post_install_tasks/runScript.sh"
    "/N/u/mehtasau/Carbonate/CC3D_PY3_GIT/CompuCell3D/CompuCell3D/post_install_tasks/paramScan.sh"
    "/N/u/mehtasau/Carbonate/CC3D_PY3_GIT/CompuCell3D/CompuCell3D/post_install_tasks/twedit++.sh"
    )
endif()
...
file(INSTALL DESTINATION "/usr/local" TYPE DIRECTORY FILES "/N/u/mehtasau/Carbonate/CC3D_PY3_GIT/CompuCell3D/CompuCell3D/core/Demos" REGEX "/[^/]*\\.svn$" EXCLUDE REGEX "/\\/N\\/u\\/mehtasau\\/Carbonate\\/CC3D\\_PY3\\_GIT\\/CompuCell3D\\/CompuCell3D\\/core\\/Demos\\/[^/]*$")
endif()
