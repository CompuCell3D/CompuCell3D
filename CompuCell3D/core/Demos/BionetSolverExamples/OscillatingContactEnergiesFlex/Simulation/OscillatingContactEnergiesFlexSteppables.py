...
class OscillatingContactEnergiesSteppable( SteppableBasePy ):
    def __init__( self, _simulator, _frequency = 1 ):
        ...
        bionetAPI.initializeBionetworkManager( _simulator )
    ...
    def start(self):
        ...
        ## Add SBML model to "cell types" called "ExternalOscillatorA" and "ExternalOscillatorB"
        ...
        ## Set initial conditions for "ExternalOscillatorA" and "ExternalOscillatorB" cell types
