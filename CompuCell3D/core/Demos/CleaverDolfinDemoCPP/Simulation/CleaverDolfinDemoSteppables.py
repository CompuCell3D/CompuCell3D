...
class CleaverDolfinDemoSteppable(SteppableBasePy):
   ...
   def step(self,mcs):
      ...
      #print 'subdomain1 ',subdomain1 
      #print 'subdomain1 custom=',dir(subdomain1) 
      ...
      start = time.time()
      ###subdomain0 = Omega0()
      # OmegaCustom0() is defined in pyinterface/dolfinCC3D/CustomSubDomains.h  and SWIG wrapper is in pyinterface/dolfinCC3D/dolfinCC3D.i   
