...
class CleaverDolfinDemoSteppable(SteppableBasePy):
   ...
   def step(self,mcs):
      ...
      # SubdomainFlex() is defined in pyinterface/dolfinCC3D/CustomSubDomains.h  and SWIG wrapper is in pyinterface/dolfinCC3D/dolfinCC3D.i   
      subdomain1 = dolfinCC3D.SubdomainFlex(self.cellField)
      #when we do not specify entities then we assume that entire mesh is the 'inside' region 
      #signature subdomain1.includeEntities( listOfCelltypes,listOfCellIds-optional)      
      #subdomain1.includeEntities([])                  
      ...
      # SubdomainFlex() is defined in pyinterface/dolfinCC3D/CustomSubDomains.h  and SWIG wrapper is in pyinterface/dolfinCC3D/dolfinCC3D.i   
      subdomain0 = dolfinCC3D.SubdomainFlex(self.cellField)
      #signature subdomain0.includeEntities( listOfCelltypes,listOfCellIds-optional)
      subdomain0.includeEntities([2])      
