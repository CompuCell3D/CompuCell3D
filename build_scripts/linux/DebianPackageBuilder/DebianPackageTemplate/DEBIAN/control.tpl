...
Depends: libc6, python2.6 | python2.7, libqtcore4 (>= 4:4.6.3), libqtgui4 (>= 4:4.6.3), libqt4-opengl,  python-opengl, python-qscintilla2 (>= 2.4.3), python-qt4 (>= 4.7.3), python-qt4-gl (>= 4.7.3), python-sip, python-vtk (>= 5.4.2), python-numpy, build-essential, libxml2-dev 
Section: science
Priority: extra
