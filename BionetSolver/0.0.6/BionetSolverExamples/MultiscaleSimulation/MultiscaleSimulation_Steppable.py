...
class MultiscaleSimulationSteppable( SteppablePy ):
    ...
    def start(self):
        ...
        sbmlModelKey = "DN"
        sbmlModelPath = os.getcwd() + "/Demos/BionetSolverExamples/sbmlModels/MinimalDeltaNotch.xml"
        ...
        sbmlModelPath = os.getcwd() + "/Demos/BionetSolverExamples/sbmlModels/CadherinCatenin_RamisConde2008.xml"
        bionetAPI.loadSBMLModel( "CadherinCatenin", sbmlModelPath, "CC", 0.05 )
        
        ## Create a bionetwork SBML model named "BloodLiverPK"
        sbmlModelPath = os.getcwd() + "/Demos/BionetSolverExamples/sbmlModels/PK_BloodLiver.xml"
