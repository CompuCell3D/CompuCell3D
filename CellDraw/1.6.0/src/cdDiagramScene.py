...
class DiagramItem(QtGui.QGraphicsPolygonItem):
    ...
    def __init__(self, pDiagramType, contextMenu, parent=None, scene=None):
        ...
        CDConstants.printOut("--------------------------------------------- DiagramItem.__init__() begin", CDConstants.DebugExcessive )
...
#             self.parentWidget.signalVisibilityTypesDockWidget.emit("Show")
...
#     "signalVisibilityTypesDockWidget"
#     "signalVisibilityControlPanelDockWidget"
# ------------------------------------------------------------
...
#             self.theControlsForImageSequence)
        ...
        # 2011 - Mitja: to access the "cell cluster controls",
        #   we add a set of buttons and sliders to the Control Panel:
        ...
        self.controlPanelDockWidgetAction = QtGui.QAction( \
                ...
                triggered=self.handleControlPanelToggleAction)
# do we need a connection like this between a signal and the toggling of the control panel?
#         # explicitly connect the "signalForPIFFTableToggle()" signal from the
#         #   theControlsForImageSequence object, to our "slot" method:
#         answer = self.theControlsForImageSequence.signalForPIFFTableToggle.connect( \
#             self.handlePIFRegionTableButton)
...
#         
    ...
    # ------------------------------------------------------------
    # 2012 - Mitja: toggle on/off the Control Panel:
    # ------------------------------------------------------------
    def handleControlPanelToggleAction(self, pBool):
        # propagate the signal upstream, for example to parent objects:
        pString = "Toggle"
        self.signalVisibilityControlPanelDockWidget.emit(pString)
        pass
    ...
    def handlePIFRegionTableButton(self, pString):
        # propagate the signal upstream, for example to parent objects:
        self.signalVisibilityTypesDockWidget.emit(pString)
