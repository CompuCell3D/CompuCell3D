...
class PixelDelegate(QtGui.QAbstractItemDelegate):
    def __init__(self, parent=None):
        ...
        self.miPaintColor = QtGui.QColor(QtCore.Qt.green)

    def setPaintColor(self, pColor):
        self.miPaintColor = QtGui.QColor(pColor)
    ...
    def paint(self, painter, option, index):
        ...
        if option.state & QtGui.QStyle.State_Selected:
# Mitja            painter.setBrush(option.palette.highlightedText())
            painter.setBrush(self.miPaintColor)
        else:
            lColor = QtGui.QColor(brightness,brightness,brightness)
#             painter.setBrush(QtGui.QBrush(QtCore.Qt.black))
            painter.setBrush(QtGui.QBrush(lColor))
...
# class PixelEditor(QtGui.QMainWindow):
class PixelEditor(QtGui.QWidget):
    def __init__(self):
        super(PixelEditor, self).__init__()


        self.setWindowTitle("Cluster Pixel Editor")
        ...
        cellIDLabel = QtGui.QLabel("Cell ID:")
        cellIDSpinBox = QtGui.QSpinBox()
        cellIDSpinBox.setMinimum(1)
        cellIDSpinBox.setMaximum(32)
        cellIDSpinBox.setValue(11)
...
# Mitja TODO add these actions somewhere else:
...
#         self.menuBar().addMenu(helpMenu)
        ...
        controlsLayout.addWidget(cellIDLabel)
        controlsLayout.addWidget(cellIDSpinBox)
        controlsLayout.addStretch(1)
...
#        self.setCentralWidget(centralWidget)
        self.layout().addWidget(centralWidget)
