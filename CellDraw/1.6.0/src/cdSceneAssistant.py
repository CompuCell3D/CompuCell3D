...
CDConstants.printOut( " cdSceneAssistant.py --- 000a - DEBUG - mi __main__ xe 00a ", CDConstants.DebugTODO )
...
#        miDialogsWindowFlags |= QtCore.Qt.WindowStaysOnTopHint
        ...
        # CDConstants.printOut( " "+str( "patternDict = ", self.patternDict )+" ", CDConstants.DebugTODO )
        ...
        # CDConstants.printOut( " "+str( "    - DEBUG ----- PIFOneRegionTable: __init__(): done" )+" ", CDConstants.DebugTODO )
    ...
    def setOneRegionDict(self, pDict):
        ...
        # CDConstants.printOut( " "+str( "___ - DEBUG ----- PIFOneRegionTable: setOneRegionDict() to", self.oneRegionDict, " done." )+" ", CDConstants.DebugTODO )
    ...
    def updateOneRegionDict(self):
        # CDConstants.printOut( " "+str( "___ - DEBUG DEBUG DEBUG ----- PIFOneRegionTable: self.updateOneRegionDict() from ", self.oneRegionDict )+" ", CDConstants.DebugTODO )
...
#         if lThereAreRegionRowsInUse == False:
...
class CDSceneAssistant(QtGui.QWizard):
    ...
    def createCellTypePage(self, pTheColorDict):
        ...
        lCellTypeLayout.setMargin(2)
        lCellTypeLayout.setSpacing(4)
        ...
        cellCC3DColorLabel.setMargin(2)
        ...
        cellNameAndTypeLayout.setMargin(2)
        ...
        self.linearDimensionsLayout.setMargin(2)
        ...
        self.targetVolumeLayout.setMargin(2)
...
#         page.setLayout(layout)
    ...
    def handleCellSizeButtonGroupClicked(self, pChecked):
        ...
        #
        if lCellSizeMode != self.cellSizeMode:
