#!/usr/bin/env python
#
# CDWaitProgressBarWithImageDialog - add-on QProgressBar dialog for CellDraw - Mitja 2011
#
# ------------------------------------------------------------
...
# ======================================================================
class CDWaitProgressBarWithImageDialog(QtGui.QDialog):
    ...
    def __init__(self, pTitle="CellDraw: processing.", pMaxValue=100, pParent=None):
        ...
        super(CDWaitProgressBarWithImageDialog, self).__init__(pParent)
        ...
        # CDConstants.printOut( " "+str( "--- - DEBUG ----- CDWaitProgressBarWithImageDialog: __init__(): done" )+" ", CDConstants.DebugTODO )
    ...
    def miInitGUI(self):
        ...
        # how will the CDWaitProgressBarWithImageDialog look like:
...
#    class's (CDWaitProgressBarWithImageDialog) case it is simply used for ***testing***:
# ======================================================================
if __name__ == '__main__':
    ...
    mainDialog = CDWaitProgressBarWithImageDialog("some explanatory text", 345)
