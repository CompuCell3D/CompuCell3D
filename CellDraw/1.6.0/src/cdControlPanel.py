...
class CDControlPanel(QtGui.QWidget):
    ...
    def __init__(self, pParent = None):
        ...
        # a QGroupBox containing the types editor,
        #    it's assigned below, in setcontrolsForTypeEditor()
        self.controlsForTypeEditor = 0
...
#         lTheImageLayerTabLayout.addWidget(self.pifHeightYInputBox)
        ...
        # ----------------------------------------------------------------
        #
        # QWidget setup (5) - prepare for a QTabView for Image Sequence controls:
        #
        #
        lTheTypeEditorTab = QtGui.QWidget()
        lTheTypeEditorTabLayout = QtGui.QVBoxLayout()
        lTheTypeEditorTabLayout.setMargin(2)
        lTheTypeEditorTabLayout.setSpacing(4)
        lTheTypeEditorTabLayout.setAlignment( QtCore.Qt.AlignLeft | QtCore.Qt.AlignTop)
        lTheTypeEditorTab.setLayout(lTheTypeEditorTabLayout)

        # ----------------------------------------------------------------
        #
        # QWidget setup (5a) - add controls for Image Sequence content:
        #
        lTypeEditorHeaderLabel = QtGui.QLabel("Type Editor")
        lTypeEditorHeaderLabel.setFont(labelHeaderFont)
        lTypeEditorHeaderLabel.setMargin(2)
        lTypeEditorHeaderLabel.setAlignment(QtCore.Qt.AlignLeft | QtCore.Qt.AlignVCenter)
        lTheTypeEditorTabLayout.addWidget(lTypeEditorHeaderLabel)

        # this QGroupBox is defined in its own class:
        lTheTypeEditorTabLayout.addWidget(self.controlsForTypeEditor)
        # lTheTypeEditorTabLayout.addStretch(10)
...
#        self.theMainTabWidget.setTabShape(QtGui.QTabWidget.Triangular)
        ...
        self.theMainTabWidget.insertTab(3, lTheTypeEditorTab, "Types")
        self.theMainTabWidget.setTabToolTip(3, "Type Editor: edit cell types and their properties")
        self.theMainTabWidget.setTabWhatsThis(3, "Type Editor: edit cell types and their properties.")


# 2012 - Mitja: todo SUPPORT drawing cells in a cluster, uncomment this tab and restart:
#
#         self.theMainTabWidget.insertTab(4, lTheClustersTab, "Clusters")
#         self.theMainTabWidget.setTabToolTip(4, "Edit Cluster: draw cells in a cluster")
#         self.theMainTabWidget.setTabWhatsThis(4, "Edit Cluster: draw cells in a cluster.")
...
# and a GUI for the image controls on the toolbar on the window!
    ...
    # ------------------------------------------------------------
    def setcontrolsForTypeEditor(self, pGroupBox):
        self.controlsForTypeEditor = pGroupBox
        # CDConstants.printOut( " "+str( "___ - DEBUG ----- CDControlPanel: setcontrolsForTypeEditor(): done" )+" ", CDConstants.DebugTODO )
