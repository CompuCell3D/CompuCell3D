...
export PATH=${PREFIX_CELLDRAW}/LIBRARYDEPS/sipDeps:${PREFIX_CELLDRAW}/LIBRARYDEPS:${PREFIX_CELLDRAW}/LIBRARYDEPS/LIBRARY-PYTHON-2.5/Extras/lib/python/wx/lib/:$PATH
echo " ====> PATH: $PATH"

# export PATH=${PREFIX_CELLDRAW}/LIBRARYDEPS/sipDeps:${PYTHONLIB26}/bin:${PYTHONLIB26}:${PREFIX_CELLDRAW}/LIBRARYDEPS:${PREFIX_CELLDRAW}/LIBRARYDEPS/LIBRARY-PYTHON-2.5/Extras/lib/python/wx/lib/:$PATH
