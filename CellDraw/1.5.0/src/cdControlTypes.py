...
#
#          signalForPIFTableToggle = QtCore.pyqtSignal(str)
#
class CDControlTypes(QtGui.QWidget):
    ...
    def __init__(self,parent=None):
        ...
        self.colors = [QtCore.Qt.green, QtCore.Qt.blue, QtCore.Qt.red, \
        ...
        self.names = ["green", "blue", "red", "darkYellow", "lightGray", \
        ...
        self.typesMainLayout.setMargin(0)
        self.typesMainLayout.setSpacing(0)
...
#     def populateControlsForTypes(self):
        ...
        self.pifTableAction = QtGui.QAction(
                ...
                shortcut=QtGui.QKeySequence.AddTab, statusTip="Toggle (show/hide) the Table of Types window",
    ...
    def createFloodFillToolButtonIcon(self, pImageFile, pColor):
        ...
        # print "OOOOOOOOOOOOOO in createFloodFillToolButtonIcon() pColor =", pColor
    ...
    def handleFillColorChanged(self):
        ...
        # print "self.chosenMenuColor is now", self.chosenMenuColor, "not", QtGui.QColor(self.chosenMenuColor)
    ...
    def handlePIFTableButton(self):
        self.signalForPIFTableToggle.emit("Toggle")
