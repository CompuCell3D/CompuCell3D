...
#         self.regionsTable.resizeRowsToContents()
    ...
    def updateRegionUseOfTableElements(self, pColor, pHowManyInUse):
        ...
        for i in xrange(self.getRegionsDictElementCount()):
            ...
            CDConstants.printOut( "___ updateRegionUseOfTableElements()  ----- self.regionsDict[lKeys[i=="+str(i)+"]] ="+str(self.regionsDict[lKeys[i]]), CDConstants.DebugAll )
            CDConstants.printOut( "___ updateRegionUseOfTableElements()  ----- self.regionsDict[lKeys[i]][0] ="+str(self.regionsDict[lKeys[i]][0]), CDConstants.DebugAll )
            if self.regionsDict[lKeys[i]][0].rgba() == lColor.rgba() :
                CDConstants.printOut( "___ updateRegionUseOfTableElements()  ----- self.regionsDict[lKeys[i]][3] ="+str(self.regionsDict[lKeys[i]][3]), CDConstants.DebugAll )
            ...
            if self.regionsDict[lKeys[i]][3] < 1:
                self.regionsTable.hideRow(i)
                CDConstants.printOut( "___ updateRegionUseOfTableElements()  ----- self.regionsTable.hideRow(i=="+str(i)+")", CDConstants.DebugAll )
            else:
                self.regionsTable.showRow(i)
                lThereAreRegionRowsInUse = True
                CDConstants.printOut( "___ updateRegionUseOfTableElements()  ----- self.regionsTable.showRow(i=="+str(i)+")", CDConstants.DebugAll )
...
#             self.regionsTable.show()
    ...
    def updateTableOfTypesForImageSequenceOn(self):
        CDConstants.printOut( "___ - DEBUG ----- CDTableOfTypes: updateTableOfTypesForImageSequenceOn() starting ----- ", CDConstants.DebugExcessive )
...
#             CDConstants.printOut( "___ updateTableOfTypesForImageSequenceOn()  ----- self.regionsDict[lKeys[i=="+str(i)+"]] ="+str(self.regionsDict[lKeys[i]]), CDConstants.DebugAll )
#             CDConstants.printOut( "___ updateTableOfTypesForImageSequenceOn()  ----- self.regionsDict[lKeys[i]][0] ="+str(self.regionsDict[lKeys[i]][0]), CDConstants.DebugAll )
            # determine if the current row at index i is to be visible or not:
            if self.regionsDict[lKeys[i]][0].rgba() == lColorForCellSeedsInImageSequence.rgba() :
                # get each used cell type's name and target volume size:
                lCellTypeName = self.regionsDict[lKeys[i]][4][0][1]
                if (lCellTypeName != lTypeNameForCellSeedsInImageSequence):
                    ...
                    lOneRegionTableWidget = self.regionsTable.cellWidget(i, 5)
                    CDConstants.printOut( "___ updateTableOfTypesForImageSequenceOn()  ----- keeping self.regionsDict[lKeys[i=="+str(i)+"]][4][0][1] ="+str(self.regionsDict[lKeys[i]][4][0][1]), CDConstants.DebugAll )
                else:
                    # if the cell type name has NOT been modified by the user, change it to something useful for Image Sequence use:
                    CDConstants.printOut( "___ updateTableOfTypesForImageSequenceOn()  ----- storing self.regionsDict[lKeys[i=="+str(i)+"]][4][0][1] ="+str(self.regionsDict[lKeys[i]][4][0][1]), CDConstants.DebugAll )
                    self.theBackupCellTypeNameWhenSwitchingToImageSequenceAndBack = lCellTypeName
                    self.regionsDict[lKeys[i]][4][0][1] = "cellSeedType"
                    ...
                    CDConstants.printOut( "___ updateTableOfTypesForImageSequenceOn()  ----- NOW self.regionsDict[lKeys[i=="+str(i)+"]][4][0][1] ="+str(self.regionsDict[lKeys[i]][4][0][1]), CDConstants.DebugAll )

                CDConstants.printOut( "___ updateTableOfTypesForImageSequenceOn()  ----- self.regionsTable.showRow(i=="+str(i)+")", CDConstants.DebugAll )
                self.regionsTable.showRow(i)
                lThereAreRegionRowsInUse = True
            else:
                CDConstants.printOut( "___ updateTableOfTypesForImageSequenceOn()  ----- self.regionsTable.hideRow(i=="+str(i)+")", CDConstants.DebugAll )
                self.regionsTable.hideRow(i)
        ...
        self.regionsTable.hideColumn(0)
        self.regionsTable.hideColumn(1)
        self.regionsTable.hideColumn(2)
        self.regionsTable.hideColumn(3)
        self.regionsTable.hideColumn(4)
        self.regionsTable.showColumn(5)
        ...
        CDConstants.printOut( "___ - DEBUG ----- CDTableOfTypes: updateTableOfTypesForImageSequenceOn() ending. ----- ", CDConstants.DebugExcessive )
    ...
    def updateTableOfTypesForImageSequenceOff(self):
        CDConstants.printOut( "___ - DEBUG ----- CDTableOfTypes: updateTableOfTypesForImageSequenceOff() starting ----- ", CDConstants.DebugExcessive )
        ...
        for i in xrange(self.getRegionsDictElementCount()):
            ...
            if self.regionsDict[lKeys[i]][0].rgba() == lColorForCellSeedsInImageSequence.rgba() :
                if (self.theBackupCellTypeNameWhenSwitchingToImageSequenceAndBack != ""):
                    ...
                    CDConstants.printOut( "___ updateTableOfTypesForImageSequenceOn()  ----- removing self.regionsDict[lKeys[i=="+str(i)+"]][4][0][1] ="+str(self.regionsDict[lKeys[i]][4][0][1]), CDConstants.DebugAll )
                    self.regionsDict[lKeys[i]][4][0][1] = self.theBackupCellTypeNameWhenSwitchingToImageSequenceAndBack
                    # modify the name in the specific region's table widget itself:
                    lOneRegionTableWidget = self.regionsTable.cellWidget(i, 5)
                    lOneRegionTableTypeNameItem = lOneRegionTableWidget.oneRegionTable.item(0, 1)
                    ...
                    # if the cell type name has NOT been modified by the user, change it to something useful for Image Sequence use:
                    lOneRegionTableWidget = self.regionsTable.cellWidget(i, 5)
                    CDConstants.printOut( "___ updateTableOfTypesForImageSequenceOn()  ----- restored self.regionsDict[lKeys[i=="+str(i)+"]][4][0][1] ="+str(self.regionsDict[lKeys[i]][4][0][1]), CDConstants.DebugAll )


            CDConstants.printOut( "___ updateTableOfTypesForImageSequenceOff()  ----- self.regionsDict[lKeys[i=="+str(i)+"]] ="+str(self.regionsDict[lKeys[i]]), CDConstants.DebugAll )
            CDConstants.printOut( "___ updateTableOfTypesForImageSequenceOff()  ----- self.regionsDict[lKeys[i]][0] ="+str(self.regionsDict[lKeys[i]][0]), CDConstants.DebugAll )
            # determine if the current row at index i is to be visible or not:
            if self.regionsDict[lKeys[i]][3] < 1:
                self.regionsTable.hideRow(i)
                CDConstants.printOut( "___ updateTableOfTypesForImageSequenceOff()  ----- self.regionsTable.hideRow(i=="+str(i)+")", CDConstants.DebugAll )
            else:
                self.regionsTable.showRow(i)
                CDConstants.printOut( "___ updateTableOfTypesForImageSequenceOff()  ----- self.regionsTable.showRow(i=="+str(i)+")", CDConstants.DebugAll )



        # show the entire table content again:
        #    show the vertical header:
        self.regionsTable.verticalHeader().show()
        #    restore the original horizontal header labels:
        self.regionsTable.setHorizontalHeaderLabels( \
             ("#", "Color", "Region", "Cell\nSize", "Use", "Cell Types in Region") )
        # show all columns:
        self.regionsTable.showColumn(0)
        self.regionsTable.showColumn(1)
        self.regionsTable.showColumn(2)
        self.regionsTable.showColumn(3)
        self.regionsTable.showColumn(4)
        self.regionsTable.showColumn(5)
        # same adjustments for the only used sub- table widget:
        if (lOneRegionTableWidget != None):
        ...
        CDConstants.printOut( "___ - DEBUG ----- CDTableOfTypes: updateTableOfTypesForImageSequenceOff() ending. ----- ", CDConstants.DebugExcessive )
    ...
    def debugRegionDict(self):
        ...
        lKeys = self.getRegionsDictKeys()
        pass # 152 prrint "---------------------------------------------"
        pass # 152 prrint " CDTableOfTypes class, regionDict global: "
        pass # 152 prrint " "
        ...
        for i in xrange(lCount):
            ...
            pass # 152 prrint "region name =   self.regionsDict[lKeys[i]][1] =", self.regionsDict[lKeys[i]][1]
            pass # 152 prrint "cellsize = self.regionsDict[lKeys[i]][2] =", self.regionsDict[lKeys[i]][2]
            for j in xrange(3):
                pass # 152 prrint "cellsizes -- at i =", i, ", j =", j, "self.regionsDict[lKeys[i]][2][j] =", self.regionsDict[lKeys[i]][2][j]
...
#         #    self.deleteCellTypeButton.setEnabled(False)
    ...
    def handleTableCellChanged(self,pRow,pColumn):
        ...
        pass # 152 prrint "___ - DEBUG ----- CDTableOfTypes: handleTableCellChanged() pRow,pColumn =" , pRow,pColumn
        # update the dict:
        self.updateRegionsDict()
    ...
    def handleOneRegionTableWidgetChanged(self):
        ...
        pass # 152 prrint "___ - DEBUG ----- CDTableOfTypes: handleOneRegionTableWidgetChanged() done."
    ...
    def on_regionsTable_cellClicked(self, row, col):
        pass # 152 prrint "___ - DEBUG ----- CDTableOfTypes: on_regionsTable_cellClicked() = ", self.regionsTable.rowCount()
        ...
        pass # 152 prrint "___ - DEBUG ----- CDTableOfTypes: on_regionsTable_cellClicked()  done."
...
#                           } )
    miDict = dict({ 1: [ QtGui.QColor(QtCore.Qt.green), "green", [10, 10, 1], 1, \
                    ...
                    6: [ QtGui.QColor(QtCore.Qt.magenta), "magenta", [10, 10, 1], 1, \
