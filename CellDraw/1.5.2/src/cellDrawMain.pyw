...
#         self.ui.label_10.hide()
    ...
    def versionWarning(self):
        ...
        pass # 152 prrint "___ - DEBUG ----- CDPreferences: versionWarning(): done"
    ...
    def handlePreferencesChanged(self):
        pass # 152 prrint "handlePreferencesChanged(self) -- # SLOT function for the signal cdPreferencesChangedSignal() from cdPreferences"
        #
        ...
        pass # 152 prrint "    self.cdPreferences. "
        pass # 152 prrint "    self.cdPreferences. "
        pass # 152 prrint "    self.cdPreferences. "
        pass # 152 prrint "    self.cdPreferences. "
        pass # 152 prrint "    self.cdPreferences. "
        pass # 152 prrint "      self.graphicsSceneWindow.theCDImageLayer.height =", self.graphicsSceneWindow.theCDImageLayer.height
        pass # 152 prrint "      self.graphicsSceneWindow.theCDImageLayer.width =", self.graphicsSceneWindow.theCDImageLayer.width
        pass # 152 prrint "    self.cdPreferences. "
        pass # 152 prrint "      self.cdPreferences.getPifSceneWidth() =", self.cdPreferences.getPifSceneWidth()
        pass # 152 prrint "      self.cdPreferences.getPifSceneHeight() =", self.cdPreferences.getPifSceneHeight()
        pass # 152 prrint "      self.cdPreferences.getPifSceneDepth() =", self.cdPreferences.getPifSceneDepth()
        pass # 152 prrint "      self.cdPreferences.pifSceneUnits =", self.cdPreferences.pifSceneUnits
        pass # 152 prrint "    self.cdPreferences. "
        pass # 152 prrint "    self.cdPreferences. "
        pass # 152 prrint "    self.cdPreferences. "
        pass # 152 prrint "    self.cdPreferences. "
        pass # 152 prrint "___ - DEBUG ----- PIFInputMainWindow: handlePreferencesChanged() done."
...
#             print "self.theTableOfTypes.show() now!"
            ...
            pass # 152 prrint "handleTogglePIFRegionTableWindow does not know what to do!"
    ...
    def handleRegionsTableWidgetChanged(self):
        ...
        pass # 152 prrint "2010 DEBUG: in handleRegionsTableWidgetChanged() the regionsTableDict is :"
        pass # 152 prrint "                  regionsTableDict keys =", lKeys
        for i in xrange(len(self.regionsTableDict)):
            pass # 152 prrint "                  regionsTableDict: i, lKeys[i], regionsTableDict[keys[i]], self.regionsTableDict[lKeys[i]][0].rgba() = ",  i, lKeys[i], self.regionsTableDict[lKeys[i]], self.regionsTableDict[lKeys[i]][0].rgba()
        ...
        pass # 152 prrint "___ - DEBUG ----- PIFInputMainWindow: handleRegionsTableWidgetChanged() done."
    ...
    def setIgnoreWhiteRegions(self, pCheckBox):
        ...
        # 2011 - Mitja: and ask for a redraw of the theCDImageLayer:
        self.graphicsSceneWindow.scene.update()
        pass # 152 prrint ">>>>>>>>>>>>>>>>>>>>>>>> PIFInputMainWindow.ignoreWhiteRegionsForPIF is now =", self.ignoreWhiteRegionsForPIF
    ...
    def setIgnoreBlackRegions(self, pCheckBox):
        ...
        # 2011 - Mitja: and ask for a redraw of the theCDImageLayer:
        self.graphicsSceneWindow.scene.update()
        pass # 152 prrint ">>>>>>>>>>>>>>>>>>>>>>>> PIFInputMainWindow.ignoreBlackRegionsForPIF is now =", self.ignoreBlackRegionsForPIF
    ...
    def setSavePIFFromGraphicsScene(self, pCheckBox):
        ...
        # 2011 - Mitja: and ask for a redraw of the theCDImageLayer:
        self.graphicsSceneWindow.scene.update()
        pass # 152 prrint ">>>>>>>>>>>>>>>>>>>>>>>> PIFInputMainWindow.thePIFMustBeSavedFromTheGraphicsScene is now =", self.thePIFMustBeSavedFromTheGraphicsScene
    ...
    def setPickColorRegion(self, pCheckBox):
        ...
        pass # 152 prrint ">>>>>>>>>>>>>>>>>>>>>>>> PIFInputMainWindow.pickColorRegion is now =", self.pickColorRegion
    ...
    def setSavePIFMetadata(self, pCheckBox):
        ...
        pass # 152 prrint ">>>>>>>>>>>>>>>>>>>>>>>> PIFInputMainWindow.savePIFMetadata is now =", self.savePIFMetadata
    ...
    def collectAllColorsInTable(self):
        ...
        lKeys = self.regionsTableDict.keys()
        pass # 152 prrint "2010 DEBUG:   in   collectAllColorsInTable() the regionsTableDict is :"
        pass # 152 prrint "                   regionsTableDict keys =", lKeys
        ...
        for i in xrange(len(self.regionsTableDict)):
            ...
            pass # 152 prrint "                  regionsTableDict: i, lKeys[i], regionsTableDict[keys[i]], self.regionsTableDict[lKeys[i]][0].rgba() = ",  i, lKeys[i], self.regionsTableDict[lKeys[i]], lColor
            #
            # update all global data structures to the new values just provided by the external table widget:
            #
        ...
        try:
            ...
            pass # 152 prrint ">>>>>>>>>>>>>>>>>>>>>>>> self.colorIds does not include 0 :", self.colorIds
...
#         self.finishedSetup = True
    ...
    def openImage(self):
        ...
        pass # 152 prrint "2010 DEBUG: openImage() STARTING with globals:",  "\n self.colorIds =", self.colorIds,  "\n self.colorDict =", self.colorDict,  "\n self.comboDict =", self.comboDict,  "\n self.regionsTableDict =", self.regionsTableDict
        ...
        if not lFileName.isEmpty():
            ...
            if lImage.isNull():
                ...
                pass # 152 prrint "2010 DEBUG: _,.- ~*'`'*~-.,_ openImage() got [", lFileName, "]"
                ...
                pass # 152 prrint "2010 DEBUG 2010 DEBUG now calling self.graphicsSceneWindow.updateBackgroundImage(lTheFileName, lImage) with ", lTheFileName, lImage
...
#         self.updateActions()
        ...
        pass # 152 prrint "2010 DEBUG: _,.- ~*'`'*~-.,_ setImageGlobals() with image: ", str(pImage), " ... done."
    ...
    def fileSavePIFFromScene_Callback(self):
        ...
        pass # 152 prrint "___ - DEBUG ----- PIFInputMainWindow: fileSavePIFFromScene_Callback() starting."
        ...
        if self.thePIFMustBeSavedFromTheGraphicsScene == True:
            ...
            if (self.graphicsSceneWindow.scene.getMode() == CDConstants.SceneModeImageSequence):
                ...
                pass # 152 prrint "___ - DEBUG ----- PIFInputMainWindow: fileSavePIFFromScene_Callback() Sequence-generated PIFF done."
                return True
            ...
            if self.cdPreferences.piffGenerationMode == CDConstants.PIFFSaveWithFixedRaster:
                ...
                if fileName.isEmpty():
                    self.theSceneRasterizerWidget.hide()
                    return False
                    pass # 152 prrint "___ - DEBUG ----- PIFInputMainWindow: fileSavePIFFromScene_Callback() fixed-size raster PIFF failed."
                else:
                    # DIH:
                    self.theSceneRasterizerWidget.savePIFFFileFromFixedSizeRaster(fileName)
                    self.theSceneRasterizerWidget.hide()
                    pass # 152 prrint "___ - DEBUG ----- PIFInputMainWindow: fileSavePIFFromScene_Callback() fixed-size raster PIFF done."
                    return True
                ...
                self.theSceneRasterizerWidget.hide()
                pass # 152 prrint "___ - DEBUG ----- PIFInputMainWindow: fileSavePIFFromScene_Callback() Potts-generated PIFF done."
                return True
                # ----------------------------------------------------------------
                ...
                if fileName.isEmpty():
                    self.theSceneRasterizerWidget.hide()
                    pass # 152 prrint "___ - DEBUG ----- PIFInputMainWindow: fileSavePIFFromScene_Callback() region-raster PIFF failed."
                    return False
                else:
                    ...
                    self.theSceneRasterizerWidget.hide()
                    pass # 152 prrint "___ - DEBUG ----- PIFInputMainWindow: fileSavePIFFromScene_Callback() region-raster PIFF done."
                    return True
                # ----------------------------------------------------------------
            ...
            if fileName.isEmpty():
                self.theSceneRasterizerWidget.hide()
                pass # 152 prrint "___ - DEBUG ----- PIFInputMainWindow: fileSavePIFFromScene_Callback() pixel-based PIFF failed."
                return False
            else:
                ...
                self.theSceneRasterizerWidget.hide()
                pass # 152 prrint "___ - DEBUG ----- PIFInputMainWindow: fileSavePIFFromScene_Callback() pixel-based PIFF done."
                return True
    ...
    def savePIFFileFromAllPixels(self, fileName):
        ...
        if not file.open( QtCore.QFile.WriteOnly | QtCore.QFile.Text):
            ...
            pass # 152 prrint "___ - DEBUG ----- PIFInputMainWindow: savePIFFileFromAllPixels() failed."
            return False
        ...
        self.regionsTableDict = self.theTableOfTypes.getRegionsDict()
        lKeys = self.regionsTableDict.keys()
        pass # 152 prrint "2010 DEBUG DEBUG DEBUG DEBUG: in savePIFFileFromAllPixels() the regionsTableDict is :"
        pass # 152 prrint "                  regionsTableDict keys =", lKeys
        for i in xrange(len(self.regionsTableDict)):
            pass # 152 prrint "                  regionsTableDict: i, lKeys[i], regionsTableDict[keys[i]] = ",  i, lKeys[i], self.regionsTableDict[lKeys[i]]
        ...
        pass # 152 prrint "___ - DEBUG ----- PIFInputMainWindow: savePIFFileFromAllPixels() done."
...
#         CDConstants.printOut(  "os.path.splitext(str(lFileName))[1] = " + str(os.path.splitext(str(lFileName))[1]), CDConstants.DebugAll )
    ...
    def fileImportImageSequence_Callback(self):
        ...
        if not lFileName.isEmpty():
            ...
            self.graphicsSceneWindow.windowPIFControlPanel.setCurrentTab(2)
...
#             probably after normalizing
        ...
        self.graphicsSceneWindow.theCDImageSequence.setCurrentIndexInSequence(0)
    ...
    def openPIFFFile(self, pFileName):
        ...
        if not QtCore.QString(pFileName).isEmpty():
            ...
            if lFileOK == False:
                ...
                pass # 152 prrint "2010 DEBUG 2010 DEBUG now calling self.graphicsSceneWindow.updateBackgroundImage(lTheFileName, image) = (", lTheFileName, image, ")."
