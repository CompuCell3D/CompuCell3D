...
class CDControlClusters(QtGui.QWidget):
    ...
    def __init__(self,parent=None):
        ...
        pass # 152 prrint "___ - DEBUG ----- CDControlClusters: __init__() "
...
#         self.imageSequenceControlsMainLayout.addWidget(self.typesGroupBox)
    ...
    def addActionToColorGroupBox(self, pGroupBox, pAction, pIsDefault=False):
        ...
        pass # 152 prrint "pAction.text() =", pAction.text()
        pass # 152 prrint "self.theColorButtonDict =", self.theColorButtonDict
...
#         return lColorMenu
    ...
    def handleCellTypeColorClicked(self):
        ...
        pass # 152 prrint self.clickedCellTypeAction
        pass # 152 prrint dir(self.clickedCellTypeAction)
        ...
        pass # 152 prrint self.chosenCellTypeColor
